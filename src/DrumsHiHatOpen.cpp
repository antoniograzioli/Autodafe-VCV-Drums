...
enum LightIds {
    ...
    int sampletype = 1;
     ...
     unsigned int count1  = HHOP_sample1_len;
     unsigned int count2  = HHOP_sample2_len;
     unsigned int count3  = HHOP_sample3_len;
     unsigned int count4  = HHOP_sample4_len;
     unsigned int count5  = HHOP_sample5_len;
     unsigned int count6  = HHOP_sample6_len;
     unsigned int count7  = HHOP_sample7_len;
     unsigned int count8  = HHOP_sample8_len;

	
	DrumsHiHatOpen() {
		config(NUM_PARAMS, NUM_INPUTS, NUM_OUTPUTS, NUM_LIGHTS);
configParam(DrumsHiHatOpen::SAMPLETYPE, 0.0, 1.0, 0.0, "");
//configParam(DrumsHiHatOpen::PITCH, -12, 12.0, 0.0, "");
    }
...
struct DrumsHiHatOpenWidget : ModuleWidget {
    ...
    //addParam(createParam<Davies1900hBlackKnob>(Vec(30, 80), module, DrumsHiHatOpen::PITCH));
