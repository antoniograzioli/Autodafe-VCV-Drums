...
enum LightIds {
   ...
   unsigned int count1  = HHCL_sample1_len;
    unsigned int count2  = HHCL_sample2_len;
    unsigned int count3  = HHCL_sample3_len;
    unsigned int count4  = HHCL_sample4_len;
    unsigned int count5  = HHCL_sample5_len;
    unsigned int count6  = HHCL_sample6_len;
    unsigned int count7  = HHCL_sample7_len;
    unsigned int count8  = HHCL_sample8_len;
...
//configParam(DrumsHiHatClosed::PITCH, -12, 12.0, 0.0, "");
    }
...
struct DrumsHiHatClosedWidget : ModuleWidget {
    ...
    //addParam(createParam<Davies1900hBlackKnob>(Vec(30, 80), module, DrumsHiHatClosed::PITCH));
